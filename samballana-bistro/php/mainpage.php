...
<body onload="loadCookies()">
    ...
    foreach ($rows as $products) {
        ...
        echo "<a  href='mainpage.php?op=cart&prodid=$prodid'><i class='fa fa-cart-plus' onclick='return cartDialog()' style='font-size:24px; color:#ff4242'></i></a>";
        echo "</div>";
        }
    echo "</div>";
    echo "</div>";
...
<div class="fab-container">
        ...
        <span class="fab-label">My Purchase </span>
				<div class="fab-icon-holder">
					<i onclick="window.location.href='#purchase';" class="fa fa-box"></i>
				</div>
                <li>
			<li>         
